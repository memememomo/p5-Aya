...
=head1 NAME
    ...
    Aya::Plugin::SQLPager - paginate with sql
...
This argument is optional. If you don't pass a table name, Aya guess table name automatically.
